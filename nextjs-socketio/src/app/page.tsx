...
export default function Home() {
  ...
  return (
    <div className="flex items-center p-4 mx-auto min-h-screen justify-center bg-red-500">
            ...
            <div className="flex flex-col justify-end bg-white h-[20rem] min-w-[33%] rounded-md shadow-md ">
              <div className="h-full last:border-b-0 overflow-y-scroll">
                {messages.map((msg, i) => {
                  return (
                    <div
                      className={msg.type === 'incoming' ? "w-full py-1 px-2 border-b border-gray-200 bg-purple-500" : "w-full py-1 px-2 bg-red-800"}
                      key={i}
                    >
                      {msg.author} : {msg.message} - {msg.type}
                    </div>
                  );
                })}
              </div>
